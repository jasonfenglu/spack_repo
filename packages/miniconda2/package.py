...
class Miniconda2(Package):
    ...
    if sys.platform == 'darwin':
        url  = "https://repo.continuum.io/miniconda/Miniconda2-4.4.10-MacOSX-x86_64.sh"
        version('4.4.10', '20e0f8851c93331f763635c89840c39c', expand=False)
    else:
    ...
    def setup_environment(self, spack_env, run_env):
        run_env.set('CONDA_PYTHON_EXE', 
                    join_path(self.prefix, 'bin', 'python'))
        run_env.set('CONDA_DEFAULT_ENV','base') 
        run_env.set('CONDA_SHLVL','1') 
        run_env.set('CONDA_PROMPT_MODIFIER','(base)') 
        run_env.set('CONDA_PREFIX',self.prefix) 
